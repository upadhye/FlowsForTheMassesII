...
class tabulated_function{
 public:
  ...
  double max1x(void) const {
    return xTable[tableSize-1];
  }

  double min1x(void) const {
    return xTable[0];
  }

  double max2x(void) const {
    return xTable[tableSizeX-1];
  }

  double min2x(void) const {
    return xTable[0];
  }

  double max2y(void) const {
    return yTable[tableSizeY-1];
  }

  double min2y(void) const {
    return yTable[0];
  }
